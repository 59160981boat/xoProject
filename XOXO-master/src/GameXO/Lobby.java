...
public class Lobby extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        btn_logout.setIcon(new javax.swing.ImageIcon(getClass().getResource("/form_lobby_icon_logout.png"))); // NOI18N
        ...
        btn_edit.setIcon(new javax.swing.ImageIcon(getClass().getResource("/form_lobby_icon_edit.png"))); // NOI18N
        ...
        btn_ranking.setIcon(new javax.swing.ImageIcon(getClass().getResource("/form_lobby_icon_ranking.png"))); // NOI18N
        ...
        btn_rules.setIcon(new javax.swing.ImageIcon(getClass().getResource("/form_lobby_icon_rules.png"))); // NOI18N
        ...
        btn_matching.setIcon(new javax.swing.ImageIcon(getClass().getResource("/form_lobby_icon_matching.png"))); // NOI18N
 ...
 void setLobby(Users users){
    ...
    if(icon==0){
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/form_register_picprofile1.gif")));
    }else if(icon==1){
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/form_register_picprofile2.gif")));
    }else if(icon==2){
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/form_register_picprofile3.gif")));
    }
    setLobbyTable();
}
 void setLobbyTable(){
